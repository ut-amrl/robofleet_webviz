...
export function ImageCard(props: {
    ...
    const dialog = (
        <Dialog maxWidth={false} fullScreen={fullScreen} onClose={handleClose} open={dialogOpen}>
            ...
            <DialogContent dividers>
                <CompressedImageViewer namespace={props.namespace} topic={props.topic} enabled={dialogOpen} />
            </DialogContent>
        </Dialog>
    );
...
export default function ImageryTab(props: { namespace: string }) {
    ...
    const topics = ['stereo/left/image_raw/compressed', 'stereo/right/image_raw/compressed'];
