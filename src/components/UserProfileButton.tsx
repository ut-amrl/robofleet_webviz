...
export default function UserProfileButton() {
    ...
    const signInButton = (
        <MenuItem onClick={doSignIn}>
            <ListItemIcon>
                <img alt="Google logo" width="32px" src={btnGoogle} />
            </ListItemIcon>
    ...
    const profileMenu = (
        <Menu id="profile-menu" anchorEl={anchor} keepMounted open={Boolean(anchor)} onClose={doClose}>
            <MenuItem disabled>
                <ListItemIcon>
                    <AccountCircle />
                </ListItemIcon>
