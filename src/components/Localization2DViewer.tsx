    ...
    useEffect(() => {
        const loadMap = async () => {
            ...
            const posData = new Float32Array(
                segments.flatMap((segment: any) => [segment.p0.x, segment.p0.y, 0, segment.p1.x, segment.p1.y, 0]),
            );
    ...
    return (
        <>
            <lineSegments frustumCulled={false} visible={props.mapVisible ?? true}>
                ...
                <lineBasicMaterial attach="material" color={props.mapColor} linewidth={1} />
            </lineSegments>
            <Pose
                x={props.x}
                y={props.y}
