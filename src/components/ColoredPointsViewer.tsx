...
export default function ColoredPointsViewer(props: {
    ...
    const colorAttrib = useMemo(() => {
        ...
        return <bufferAttribute attachObject={['attributes', 'color']} args={[data, 3, false]} count={length} />;
    }, [msg, length]);
    ...
    return (
        ...
        >
            ...
            <pointsMaterial attach="material" vertexColors={true} size={props.pointSize ?? 4} />
        </points>
    );
}
