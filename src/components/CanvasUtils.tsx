...
function CanvasUtils(props: CanvasUtilsProps, ref: Ref<CanvasUtilsRef>) {
    ...
    if (!three) throw new Error('CanvasUtils must be rendered inside a react-three-fiber <Canvas> component.');
    ...
    const getNdcMousePos = () => {
        ...
        return new Vector3(((x - left) / (right - left)) * 2 - 1, -(((y - top) / (bottom - top)) * 2 - 1), 0);
    };
