...
export default function VisualizationViewer(props: {
    ...
    return (
        <>
            ...
            {baseLinkMsg && (
                <ColoredLinesViewer msg={baseLinkMsg} matrix={baseLinkMatrix} visible={props.linesVisible} />
            )}
            {mapMsg && <ColoredPointsViewer msg={mapMsg} visible={props.pointsVisible} />}
            {baseLinkMsg && (
                <ColoredPointsViewer msg={baseLinkMsg} matrix={baseLinkMatrix} visible={props.pointsVisible} />
            )}
        </>
    );
}
