...
export default function ColoredLinesViewer(props: {
    ...
    const colorAttrib = useMemo(() => {
        ...
        return <bufferAttribute attachObject={['attributes', 'color']} args={[data, 3, false]} count={length * 2} />;
    }, [msg, length]);
    ...
    return (
        ...
        >
            ...
            <lineBasicMaterial attach="material" vertexColors={true} linewidth={props.lineWidth ?? 3} />
        </lineSegments>
    );
}
