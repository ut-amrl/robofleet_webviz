...
function createPose2DfMsg({ namespace, x, y, theta }: { namespace: string; x: number; y: number; theta: number }) {
...
function createLocalization2DMsg({
    ...
    fb.std_msgs.Header.addStamp(fbb, fb.RosTime.createRosTime(fbb, Math.floor(Date.now() / 1000), 0));
